...
screen navigation():
    ...
    fixed:
        ...
        if main_menu:
            ...
            imagebutton auto "gui/mm_start_%s.png" xpos 0 ypos 10000 focus_mask True action Start() hovered [Play("sound","audio/click.wav")]
        ...
        imagebutton auto "gui/mm_save_%s.png" xpos 140 ypos 140 focus_mask True action ShowMenu("load") hovered [Play("sound","audio/click.wav")]

        #textbutton _("Pengaturan") action ShowMenu("preferences")
        imagebutton auto "gui/mm_setting_%s.png" xpos 0 ypos 280 focus_mask True action ShowMenu("preferences") hovered [Play("sound","audio/click.wav")]
        ...
        imagebutton auto "gui/mm_info_%s.png" xpos 140 ypos 420 focus_mask True action ShowMenu("about") hovered [Play("sound","audio/click.wav")]

        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):

            ## Bantuan tidak perlu atau relevan dengan perangkat mobile.
            #textbutton _("Bantuan") action ShowMenu("help")
            imagebutton auto "gui/mm_help_%s.png" xpos 0 ypos 560 focus_mask True action ShowMenu("help") hovered [Play("sound","audio/click.wav")]
        ...
        if renpy.variant("pc"):
            ...
            imagebutton auto "gui/mm_quit_%s.png" xpos 140 ypos 700 focus_mask True action Quit(confirm=not main_menu) hovered [Play("sound","audio/click.wav")]
...
screen main_menu():
    ...
    fixed:
        ...
        if main_menu:
            ...
            #textbutton _("Mulai") action Start()
            imagebutton auto "gui/mm_start_%s.png" xpos 4 ypos 10 focus_mask True action Start() hovered [Play("sound","audio/click.wav")]
        ...
        #textbutton _("Muat") action ShowMenu("load")
        imagebutton auto "gui/mm_save_%s.png" xpos 170 ypos 150 focus_mask True action ShowMenu("load") hovered [Play("sound","audio/click.wav")]

        #textbutton _("Pengaturan") action ShowMenu("preferences")
        imagebutton auto "gui/mm_setting_%s.png" xpos 4 ypos 300 focus_mask True action ShowMenu("preferences") hovered [Play("sound","audio/click.wav")]
        ...
        #textbutton _("Tentang") action ShowMenu("about")
        imagebutton auto "gui/mm_info_%s.png" xpos 4 ypos 600 focus_mask True action ShowMenu("about") hovered [Play("sound","audio/click.wav")]

        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):

            ## Bantuan tidak perlu atau relevan dengan perangkat mobile.
            #textbutton _("Bantuan") action ShowMenu("help")
            imagebutton auto "gui/mm_help_%s.png" xpos 170 ypos 450 focus_mask True action ShowMenu("help") hovered [Play("sound","audio/click.wav")]
        ...
        if renpy.variant("pc"):
            ...
            ## Web.
            #textbutton _("Keluar") action Quit(confirm=not main_menu)
            imagebutton auto "gui/mm_quit_%s.png" xpos 170 ypos 750 focus_mask True action Quit(confirm=not main_menu) hovered [Play("sound","audio/click.wav")]
...
screen about():
    ...
    ## game_menu.
    use game_menu(_("Kamus"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Bismillah semoga skripsi cepat selesai hiks uweeeeeeee")
    ...
    use game_menu(_("Bantuan"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Keterangan") action SetScreenVariable("device", "mouse")
